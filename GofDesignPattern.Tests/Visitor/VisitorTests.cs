using GofDesignPattern.Tests.Composite;
using GofDesignPattern.Visitor;
using Directory = GofDesignPattern.Visitor.Directory;
using File = GofDesignPattern.Visitor.File;

namespace GofDesignPattern.Tests.Visitor
{
    /// <summary>
    /// <see cref="DirectoryTests.DirectoryPrintTest"/>とほぼ同じ
    /// </summary>
    public class VisitorTests
    {
        [Fact]
        public void OkVisitAndAccept()
        {
            // Arrange
